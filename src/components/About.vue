<template>
  ...
  <!--
    <p class="paragraph font-weight-regular">
      The California Polytechnic University, Pomona SAE Supermileage club has two teams, engineering and computer
      science.
      The engineering team maintains and helps with the designs of the car, cfd, engineering reports for competition.
      The computer science team works on the hardware for the autonomous systems, machine learning for navigation, and
      computer vision.
